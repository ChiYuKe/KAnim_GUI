...
{
    public static class KAnimDiagnosticsEngine
    {
        public static IReadOnlyList<KAnimDiagnostic> Analyze(KAnimDataPackage package)
        {
            ...
            if (package.HasTexture && package.Build != null)
            {
                AnalyzeTexture(package.TextureWidth!.Value, package.TextureHeight!.Value, package.Build, diagnostics);
            }
        ...
        public static string FormatReport(KAnimDataPackage package, IReadOnlyList<KAnimDiagnostic> diagnostics)
        {
        ...
        private static void AnalyzePackage(KAnimDataPackage package, List<KAnimDiagnostic> diagnostics)
        {
